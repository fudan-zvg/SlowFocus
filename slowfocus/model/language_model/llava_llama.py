...
from slowfocus.model.llava_arch import LLaVAMetaModel, LLaVAMetaForCausalLM


class LlavaConfig(LlamaConfig):
    model_type = "llava"

class LlavaAttLlamaModel(LLaVAMetaModel, LlamaModel):
    config_class = LlavaConfig

    def __init__(self, config: LlamaConfig):
        super(LlavaAttLlamaModel, self).__init__(config)

class LlavaLlamaAttForCausalLM(LlamaForCausalLM, LLaVAMetaForCausalLM):
    config_class = LlavaConfig
